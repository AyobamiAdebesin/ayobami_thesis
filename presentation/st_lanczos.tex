  ...
  \frametitle {Interesting Questions}
	\begin{center}
		\begin{itemize}
			...
			\item \large How does symmetry in the decomposition of $A-\sigma B$ impact the spectral transformation Lanczos algorithm?
		\end{itemize}
	\end{center}
\end{frame}
...
\begin{frame}
  ...
  {\bf Cons:}
  \begin{itemize}
  \item The generalized eigenvector computation is not unconditionally stable.
  \end{itemize}
\end{frame}
