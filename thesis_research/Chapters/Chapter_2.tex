...
\end{equation}
In theory, the vectors $q_j$ should be orthonormal, but due to floating-point errors, there will be loss of orthogonality, hence the need for line $9$ in Algorithm~\ref{alg:lanczos_algorithm}.
