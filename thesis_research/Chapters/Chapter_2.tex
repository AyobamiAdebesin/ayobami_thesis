...
To compute the eigenvalues and eigenvectors that satisfy (\ref{eq:GenEigVal_Problem}) with \added{the} spectral transformation Lanczos algorithm, our approach will be in two steps:
\begin{itemize}
	\item[$\bullet$] Transform the generalized problem into a spectral transformed standard eigenvalue problem.
	\item[$\bullet$] Solve the spectral problem with \added{the} Lanczos algorithm.
\end{itemize}
